...
SOURCE_UNIVERSE = [
    ...
    SourceTarget("AMD", "primary_company", "core", ("sec_filing", "earnings_transcript", "press_release")),
    SourceTarget("Vertiv", "primary_company", "core", ("sec_filing", "earnings_transcript", "press_release")),
    SourceTarget("Eaton", "primary_company", "core", ("sec_filing", "earnings_transcript", "press_release")),
